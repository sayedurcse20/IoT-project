...
<nav class="navbar navbar-inverse">
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav">
      ...
      <li class="active"><a href="home1.php">Temp</a></li>
      <li><a href="home2.php">CO2</a></li>
	  <li><a href="home3.php">Humidity</a></li>
	  <li><a href="home4.php">FeelsLike</a></li>
	  <li>
<div class = "dropdown">
   ...
   <ul class = "dropdown-menu pull-right" role = "menu" aria-labelledby = "dropdownMenu1">
      ...
      <li role = "presentation">
         <a href="compare1.php"><center>Humidity</center></a>
      </li>
      <li role = "presentation">
         <a href="compare1.php"><center>Temperature</center></a>
      </li> 
	...
	<div class="row"> 
		<div class="col-md-12">
			...
			<div class="image" style="max-width:500px;margin-top:70px;">
			  ...
			  <img class="mySlides w3-animate-fading" src="pic4.jpg" style="width:100%">

...
<div class="container" style="margin-bottom:20px;">
	<div class="row"> 
		<div class="col-md-12">
			...
			<h1 class="imran"><b>"CO2 Values of different Area of Dhaka City"</b></h1>
			...
			<div class="image" style="max-width:500px;margin-top:70px;">
			  ...
			  <img class="mySlides w3-animate-fading" src="image/co2/Measuring Value of CO2(ppm) for Every Ten Minitues in Jahangirnagar University.png" style="width:100%">
			  <img class="mySlides w3-animate-fading" src="image/co2/Measuring Value of CO2(ppm) for every Ten Minitues in Shymoli Office Room.png" style="width:100%">
			  <img class="mySlides w3-animate-fading" src="image/co2/Measuring Value of CO2(ppm) for Every Ten Minitues in Shymoli.png" style="width:100%">
			  <img class="mySlides w3-animate-fading" src="image/co2/Measuring Value of CO2(ppm) for every Twenty Minitues in Mirpur Area.png" style="width:100%">

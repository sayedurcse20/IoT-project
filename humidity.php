...
<nav class="navbar navbar-inverse">
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav">
	  ...
	  <li class="active"><a href="humidity.php">Humidity</a></li>
...
<div class="container" style="margin-bottom:20px;">
	<div class="row"> 
		<div class="col-md-12">
			...
			<h1 class="prothm"><b>"Humidity Values of different Area of Dhaka City"</b></h1>
			...
			<div class="image" style="max-width:500px;margin-top:70px;">
			  ...
			  <img class="mySlides w3-animate-fading" src="image/Humidity/Measuring Value of Humidity for every Twenty Minitues in Mirpur.png" style="width:100%">
			  <img class="mySlides w3-animate-fading" src="image/Humidity/Measuring Value of Humidity for every Twenty Minitues in Shymoli Office Room.png" style="width:100%">
			  <img class="mySlides w3-animate-fading" src="image/Humidity/Measuring Value of Humidity for every Twenty Minitues in Shymoli.png" style="width:100%">
			  <img class="mySlides w3-animate-fading" src="image/Humidity/Measuring Value of Humidity for every Twenty Minitues Jahangirnagar University.png" style="width:100%">

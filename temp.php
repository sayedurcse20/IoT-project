...
<nav class="navbar navbar-inverse">
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav">
      ...
      <li class="active"><a href="temp.php">Temp</a></li>
...
<div class="container" style="margin-bottom:20px;">
	<div class="row"> 
		<div class="col-md-12">
			...
			<h1 class="balake"><b>"Temperature Values of different Area of Dhaka City"</b></h1>
			...
			<div class="image" style="max-width:500px;margin-top:70px;">
			  ...
			  <img class="mySlides w3-animate-fading" src="image/temp/Measuring  Value of Temperature and Feels Like for every 20 Minute in Shymoli.png" style="width:100%">
			  ...
			  <img class="mySlides w3-animate-fading" src="image/temp/Measuring Value of Temperature and Feels Like for every 20 Minute in Jahangirnagar University.png" style="width:100%">
			  <img class="mySlides w3-animate-fading" src="image/temp/Measuring Value of Temperature and Feels Like for every 20 Minute in Mirpur.png" style="width:100%">
			  <img class="mySlides w3-animate-fading" src="image/temp/Measuring Value of Temperature and Feels Like for every 20 Minute in Shymoli Office Room.png" style="width:100%">
